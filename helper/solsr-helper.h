 ...
 */
#ifndef SOLSR_HELPER_H
#define SOLSR_HELPER_H
 ...
 */
class SOlsrHelper : public Ipv4RoutingHelper
{
public:
  /**
...
private:
   ...
   */
  SOlsrHelper &operator = (const SOlsrHelper &o);
